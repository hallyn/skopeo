...
binary-local-static:
	$(GPGME_ENV) $(GO) build -a -x -v -ldflags "-extldflags \"-static\" -X main.gitCommit=${GIT_COMMIT}" -gcflags "$(GOGCFLAGS)" -tags "netgo osusergo static static_build static_all $(BUILDTAGS) static" -o skopeo ./cmd/skopeo
